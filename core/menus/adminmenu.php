...
<!-- admin menu for the admin.php page -->
	<div id="wtw_adminmenubutton" class="wtw-mainmenubutton" onclick="WTW.toggleAdminMenu(this.id, 'left');" style="left:0px;bottom:33px;" onmouseover="WTW.hide('wtw_itooltip');">
			...
			<div class="wtw-menubuttontext"><?php echo $wtwadminmenu->__("Admin"); ?></div>
		...
		<div id="wtw_adminmenu3d" class="wtw-mainmenu3d">
			<div id="wtw_adminmenuscroll" class="wtw-mainmenuscroll">
				<div id="wtw_adminmenu1" class="wtw-adminmenuform" style="display:block;visibility:visible;">
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Admin Menu"); ?></div><br />
<?php				echo $wtwadminmenu->getAdminMenu(); ?>
				</div>
				<div id="wtw_adminmenu2" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Select 3D Building"); ?></div><br />
					<br />
					<div id="wtw_loadingbuildingid" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
					<div id="wtw_listbuildings"></div>
					<br />
					<div class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu4" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Options and Settings"); ?></div><br />
<?php				echo $wtwadminmenu->getAdminSubMenu('buildingoptions'); ?>
					<br />
					<div id="wtw_cancel4" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu5" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Building Information"); ?></div><br />
					<div id="wtw_loadingbuildingform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/building.php'; ?>
					<br />
					<div id="wtw_cancel5" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu6" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit 3D Building"); ?></div><br />
...
<?php				echo $wtwadminmenu->getAdminSubMenu('editbuilding'); ?>
					<br />
					<div id="wtw_cancel6" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Done Editing"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu9" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div id="wtw_loadingsharebuildingform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/buildingshare.php'; ?>
					<br />
					<div id="wtw_bsharebuildingtemp" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Share 3D Building as Template"); ?></div>
					<div id="wtw_adminmenubuildsharecancel" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu10" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Add 3D Building Block"); ?></div><br />
					...
					<br />
					<div id="wtw_cancel10" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu11" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div id="wtw_editmoldformtitle" class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit 3D Building Block"); ?></div><br />
<?php				include './core/forms/mold.php'; 
					echo $wtwadminmenu->getAdminSubMenu('editmold'); ?>
					<br />
					<div id="wtw_bsavethismold" class="wtw-greenbutton" onclick="WTW.submitMoldForm(1);WTW.hideAdminMenu();WTW.backToEdit();" style="font-size:1.4em;"><div class="wtw-altkey2">ctrl+s</div><?php echo $wtwadminmenu->__("Save Mold"); ?></div>
					<div id="wtw_bdelmold" class="wtw-redbutton" onclick="WTW.submitMoldForm(0);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Delete Mold"); ?></div>
					<div id="wtw_bcancelmold" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu12" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Add 3D Web Object"); ?></div><br />
					...
					<br />
					<div id="wtw_cancel12" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu13" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Add 3D Thing"); ?></div><br />
					...
					<div id="wtw_loadingthingmoldsbuttonlist" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
					<div id="wtw_thingmoldsbuttonlist"></div>
					<br />
					<div id="wtw_cancel13" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu14" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div id="wtw_editconnectinggridsformtitle" class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit 3D Building Location"); ?></div><br />
<?php				include './core/forms/connectinggrids.php'; ?>
					<br />
					<div id="wtw_beditconnectinggrid" class="wtw-greenbutton" onclick="WTW.submitConnectingGridsForm(1);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Location"); ?></div>
					<div id="wtw_bdelconnectinggrid" class="wtw-redbutton" onclick="WTW.openConfirmation('3');"><?php echo $wtwadminmenu->__("Delete 3D Building"); ?></div>
					<div id="wtw_cancel14" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu15" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Add or Edit Actions"); ?></div><br />
					...
					<div id="wtw_editexistingactionzonediv">
						<h2 style="margin-bottom:3px;"><?php echo $wtwadminmenu->__("Select Action Zone to Edit"); ?></h2>
						<select id="wtw_selectactionzoneid">
							<option value="0"><?php echo $wtwadminmenu->__("Select Action Zone"); ?></option>
						</select>
						<br/> 
						<hr class="wtw-menuhr" />
						<h2 style="margin-bottom:3px;"><?php echo $wtwadminmenu->__("Add New Action Zone"); ?></h2>
					</div>
					<div id="wtw_actionzonesbuttonlist"></div>
					<br />
					<div id="wtw_cancel15" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu16" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Recover Deleted Items"); ?></div><br />
					<h2 style="margin-bottom:3px;"><?php echo $wtwadminmenu->__("Deleted Items"); ?></h2>
					<div id="wtw_deleteditemslist"></div>
					<br />
					<div id="wtw_cancel16" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu20" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div id="wtw_editactionzoneformtitle" class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit Action Zone"); ?></div><br />
<?php				include './core/forms/actionzone.php'; ?>
					<br />
					<div id="wtw_beditactionzone" class="wtw-greenbutton" onclick="WTW.submitActionZoneForm(1);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Action Zone"); ?></div>
					<div id="wtw_bdelactionzone" class="wtw-redbutton" onclick="WTW.submitActionZoneForm(0);"><?php echo $wtwadminmenu->__("Delete Action Zone"); ?></div>
					<div id="wtw_cancel20" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu22" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Select 3D Community"); ?></div><br />
					<br />
					<div id="wtw_loadingcommunityid" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
					<div id="wtw_listcommunities"></div>
					<br />
					<div id="wtw_cancel22" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
...
<?php				echo $wtwadminmenu->getAdminSubMenu('communityoptions'); ?>
					<br />
					<div id="wtw_adminmenucommdone" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu25" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Community Information"); ?></div><br />
					<div id="wtw_loadingcommunityform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/community.php'; ?>
					<br /><br />
					<div id="wtw_cancel25" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
				</div>
				<div id="wtw_adminmenu26" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit 3D Community"); ?></div><br />
					<div class="wtw-menulevel0text"><strong>Right Click</strong> an Item on your scene to <strong>Edit</strong> the Item or select from the following:</div>
<?php				echo $wtwadminmenu->getAdminSubMenu('editcommunity'); ?>
				...
				<div id="wtw_adminmenu28" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Set First 3D Building"); ?></div><br />
<?php				include './core/forms/firstbuilding.php'; ?>
					<br />
					<div id="wtw_beditfirstbuilding" class="wtw-greenbutton" onclick="WTW.submitFirstBuildingForm(1);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Location"); ?></div>
					<div id="wtw_cancel28" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu29" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<a href="https://www.walktheweb.com/wiki/share-3d-objects/" title="Help" alt="Help" class="wtw-helplink" target="_blank">?</a>
					<div id="wtw_loadingsharecommunityform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/communityshare.php'; ?>
					<br />
					<div id="wtw_bsharecommunitytemp" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Share 3D Community as Template"); ?></div>
					<div id="wtw_cancel29" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu30" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit Landscape and Scene"); ?></div><br />
...
<?php				echo $wtwadminmenu->getAdminSubMenu('editlandscape'); ?>
					<br />
					<div id="wtw_cancel30" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Done with Scene"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu32" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Select 3D Thing"); ?></div><br />
					<br />
					<div id="wtw_loadingthingid" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
...
<?php				echo $wtwadminmenu->getAdminSubMenu('thingoptions'); ?>
					<br />
					<div id="wtw_adminmenuthingdone" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu35" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Thing Information"); ?></div><br />
					<div id="wtw_loadingthingform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/thing.php'; ?>
					<br />
					<div id="wtw_cancel35" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu36" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Edit 3D Thing"); ?></div><br />
					<div class="wtw-menulevel0text"><strong>Right Click</strong> an Item on your scene to <strong>Edit</strong> the Item or select from the following:</div>
<?php				echo $wtwadminmenu->getAdminSubMenu('editthing'); ?>
					<br />
					<div id="wtw_adminmenuthingdoneediting" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><div class="wtw-altkey2">ctrl+d</div><?php echo $wtwadminmenu->__("Done Editing"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu39" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<a href="https://www.walktheweb.com/wiki/share-3d-objects/" title="Help" alt="Help" class="wtw-helplink" target="_blank">?</a>
					<div id="wtw_loadingsharethingform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/thingshare.php'; ?>
					<br />
					<div id="wtw_bsharethingtemplate" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Share 3D Thing as Template"); ?></div>
					<div id="wtw_cancel39" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu40" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Sky Settings"); ?></div><br />
					<a href="https://www.walktheweb.com/wiki/3d-community-sky-settings/" title="Help" alt="Help" class="wtw-helplink" target="_blank">?</a>
					<div id="wtw_loadingskysettingsform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/skydome.php'; ?>
					<br />
					<div id="wtw_bsaveeditskydome" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Sky"); ?></div>
					<div id="wtw_cancel40" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu41" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Ground Settings"); ?></div><br />
					<a href="https://www.walktheweb.com/wiki/3d-community-ground-settings/" title="Help" alt="Help" class="wtw-helplink" target="_blank">?</a>
					<div id="wtw_loadinggroundsettingsform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/groundsettings.php'; ?>
					<br />
					<div id="wtw_bsaveground" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Ground"); ?></div>
					<div id="wtw_cancel41" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
...
<?php				include './core/forms/waterdepth.php'; ?>
				...
				<div id="wtw_adminmenu44" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Set Default Start Position"); ?></div><br />
					...
					<br />
					<br />
					<div id="wtw_spawnadvancedoptslink" onclick="WTW.toggleAdvanced(this, 'wtw_spawnadvancedopts');" class="wtw-showhideadvanced">-- Show Advanced Options --</div>
					<div id="wtw_spawnadvancedopts" style="display:none;visibility:hidden;">
						<br /><br />
						<h2 class="wtw-center">Select Default Spawn Zone</h2>
						<select id="wtw_tdefaultspawnzone"></select><br /><br />
						<div id="wtw_savespawnzone" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Spawn Zone"); ?></div>
					</div><br /><br />
					<div id="wtw_cancel44" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu45" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Community Gravity"); ?></div><br />
					<a href="https://www.walktheweb.com/wiki/3d-community-gravity/" title="Help" alt="Help" class="wtw-helplink" target="_blank">?</a>
					<h2 class="wtw-center"><?php echo $wtwadminmenu->__("Amount of Gravity"); ?></h2>
					...
					<br />
					<div id="wtw_savecommgravity" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);" style="font-size:1.4em;"><?php echo $wtwadminmenu->__("Save Gravity"); ?></div>
					<div id="wtw_cancel45" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu60" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("Permissions"); ?></div><br />
					<div id="wtw_loadinguserdevaccessform" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/userdevaccess.php'; ?>
					<br />
					<div id="wtw_cancel60" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu61" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Community Browse Access"); ?></div><br />
					<div id="wtw_loadinguserdevaccessform2" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/useraccess.php'; ?>
					<br />
					<div id="wtw_cancel61" class="wtw-yellowbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Cancel"); ?></div>
					<br /><br />
				</div>
				<div id="wtw_adminmenu69" class="wtw-adminmenuform" style="display:none;visibility:hidden;">
					...
					<div id="wtw_snapshottitle" class="wtw-menuheader"><?php echo $wtwadminmenu->__("3D Community Snapshot"); ?></div><br />
					<div id="wtw_loadingupdatesnapshot" class="wtw-loadingnotice" style="margin-left:auto;margin-right:auto;color:#000000;"><?php echo $wtwadminmenu->__("Loading"); ?></div>
<?php				include './core/forms/updatesnapshot.php'; ?>
					<br />
					<div id="wtw_cancel69" class="wtw-greenbutton" onclick="WTW.adminMenuItemSelected(this);"><?php echo $wtwadminmenu->__("Done"); ?></div>
					<br /><br />
				</div>
...
<?php		if ($wtwdb->hasPermission(array("admin","developer","architect","graphics artist"))) { ?>
			<div id="wtw_quickeditorsettings" class="wtw-menulevel0" style="text-align:center;position:absolute;z-index:8000;bottom:0px;width:320px;margin:0px;padding-left:0px;padding-right:0px;border-top:#333333;">
				<div style="width:100%;text-align:center;margin-top:0px;">
					...
					<div id="wtw_bavatarcamera" onclick="WTW.setQuickEditorAvatarCamera(0);" class="wtw-quickbar" title="Camera is Attached to Avatar" alt="Camera is Attached to Avatar"><?php echo $wtwadminmenu->__("Avatar"); ?><br /><?php echo $wtwadminmenu->__("Camera"); ?><br /><?php echo $wtwadminmenu->__("ON"); ?></div>
					<div id="wtw_bfocus" onclick="WTW.setQuickEditorFocus(0);" class="wtw-quickbar" title="Focus Highlight is On" alt="Focus Highlight is On"><?php echo $wtwadminmenu->__("Focus"); ?><br /><br /><?php echo $wtwadminmenu->__("ON"); ?></div>
					<div id="wtw_bmerged" onclick="WTW.setQuickEditorMerged(1);" class="wtw-quickbaroff" title="Merged Shapes are Hidden" alt="Merged Shapes are Hidden"><?php echo $wtwadminmenu->__("Merged"); ?><br /><br /><?php echo $wtwadminmenu->__("OFF"); ?></div>
					<div id="wtw_bzones" onclick="WTW.setQuickEditorZones(1);" class="wtw-quickbaroff" title="Action Zones are Hidden" alt="Action Zones are Hidden"><?php echo $wtwadminmenu->__("Zones"); ?><br /><br /><?php echo $wtwadminmenu->__("OFF"); ?></div>
					<div id="wtw_bloadall" onclick="WTW.setQuickEditorLoadAll(1);" class="wtw-quickbaroff" title="Load Active Action Zones" alt="Load Active Action Zones"><?php echo $wtwadminmenu->__("Load"); ?><br /><?php echo $wtwadminmenu->__("All"); ?><br /><?php echo $wtwadminmenu->__("OFF"); ?></div>
					<div id="wtw_blines" onclick="WTW.setQuickEditorLines(0);" class="wtw-quickbar" title="Alignment Lines are Shown" alt="Alignment Lines are Shown"><?php echo $wtwadminmenu->__("Lines"); ?><br /><br /><?php echo $wtwadminmenu->__("ON"); ?></div>
					<br /><br />
				</div>
			</div>
<?php		} ?>
