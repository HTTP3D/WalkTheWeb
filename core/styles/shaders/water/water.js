...
(function () {
    WORLDMONGER.WaterMaterial = function (name, scene, light) {
        ...
        this.bumpTexture = new BABYLON.Texture("/core/styles/shaders/water/bump.png", scene);
        //this.bumpTexture = new BABYLON.Texture("/core/styles/shaders/water/waterwaves.png", scene);
        ...
        this.reflectionTexture = new BABYLON.MirrorTexture("waterreflection", 1024, scene, true);
        this.refractionTexture = new BABYLON.RenderTargetTexture("waterrefraction", 1024, scene, true);        
        ...
        this.waterColor = new BABYLON.Color3(0.0, 0.1, 0.2);
    ...
    WORLDMONGER.WaterMaterial.prototype.isReady = function (mesh) {
        ...
        this._effect = engine.createEffect("/core/styles/shaders/water/water",
            ["position", "normal", "uv"],
    ...
    WORLDMONGER.WaterMaterial.prototype.bind = function (world, mesh) {
        this._time += 0.0002 * this._scene.getAnimationRatio();
