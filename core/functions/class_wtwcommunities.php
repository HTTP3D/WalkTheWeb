			...
			if ($wtwhandlers->checkUpdateAccess($zcommunityid, "", "")) {
				...
				$wtwhandlers->query("
					...
					set sceneambientcolor='".$zsceneambientcolor."',
						...
						sunpositionx=".$wtwhandlers->checkNumber($zsunpositionx,0).",
						sunpositiony=".$wtwhandlers->checkNumber($zsunpositiony,1000).",
						sunpositionz=".$wtwhandlers->checkNumber($zsunpositionz,0).",
						...
						backlightpositionx=".$wtwhandlers->checkNumber($zbacklightpositionx,0).",
						backlightpositiony=".$wtwhandlers->checkNumber($zbacklightpositiony,1000).",
						backlightpositionz=".$wtwhandlers->checkNumber($zbacklightpositionz,0).",
				...
				foreach ($zresults as $zrow) {
					...
					$wtwhandlers->query("
						...
						values
							...
							".$wtwhandlers->checkNumber($zrow["castshadows"],0).",
							...
							'".$zrow["csgmoldid"]."',
							'".$zrow["csgaction"]."',
							".$wtwhandlers->checkNumber($zrow["physicsenabled"],0).",
							".$wtwhandlers->checkNumber($zrow["physicscenterx"],0).",
							".$wtwhandlers->checkNumber($zrow["physicscentery"],0).",
							".$wtwhandlers->checkNumber($zrow["physicscenterz"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsextentsx"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsextentsy"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsextentsz"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsfriction"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsistriggershape"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsmass"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointax"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointay"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointaz"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointbx"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointby"],0).",
							".$wtwhandlers->checkNumber($zrow["physicspointbz"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsradius"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsrestitution"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsrotationw"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsrotationx"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsrotationy"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsrotationz"],0).",
							".$wtwhandlers->checkNumber($zrow["physicsstartasleep"],0).",
							'".$zrow["alttag"]."',
							'".$zrow["jsfunction"]."',
							'".$zrow["jsparameters"]."',
							now(),
