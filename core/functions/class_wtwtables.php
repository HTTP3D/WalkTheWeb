...
class wtwtables {
		...
		try {
			...
			$wtwdb->deltaCreateTable("
				CREATE TABLE `".wtw_tableprefix."plugins` (
				  ...
				  `deleteduserid` varchar(16) DEFAULT '',
				  `deleted` int(11) DEFAULT '0',
				  `pluginid` varchar(16) DEFAULT NULL,
	...
	public function loadInitDbData($zuserid) {
		...
		try {
			...
			$wtwdb->query("
				...
				('3b9bt5c70igtmqux','Anonymous','Anonymous Male','/content/system/avatars/male/','maleidle.babylon','male',0.0800,0.0800,0.0800,1,213,'malefull.png','maleface.png',2,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('641svy8bwjx2kme7','Default','Remy','/content/system/avatars/remy/','remyidle.babylon','male',0.0400,0.0400,0.0400,1,196,'remyfull.png','remyface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('9e94useo7x2ief0s','Default','Liam','/content/system/avatars/liam/','liamidle.babylon','male',0.0400,0.0400,0.0400,1,200,'liamfull.png','liamface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('aajvq38y06vulgh0','Default','Pearl','/content/system/avatars/pearl/','pearlidle.babylon','female',0.0700,0.0700,0.0700,1,325,'pearlfull.png','pearlface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('dihtmpm1ae3b9d3a','Default','Malcolm','/content/system/avatars/malcolm/','malcolmidle.babylon','male',0.0400,0.0400,0.0400,1,195,'malcolmfull.png','malcolmface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('h1ro3h59xs5eknl0','Default','Shae','/content/system/avatars/shae/','shaeidle.babylon','female',0.0400,0.0400,0.0400,1,303,'shaefull.png','shaeface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('odtx7arzof5eigp4','Default','Regina','/content/system/avatars/regina/','reginaidle.babylon','female',0.0400,0.0400,0.0400,1,241,'reginafull.png','reginaface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				
				('p7y3p6ti6d85yf7q','Anonymous','Anonymous Female','/content/system/avatars/female/','femaleidle.babylon','female',0.0800,0.0800,0.0800,1,100,'femalefull.png','femaleface.png',1,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('r8tgsns20ruwx0bg','Default','Jasper','/content/system/avatars/jasper/','jasperidle.babylon','male',0.0700,0.0700,0.0700,1,71,'jasperfull.png','jasperface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0),
				('v1ij2rkmdypo97c2','Default','Stefani','/content/system/avatars/stefani/','stefaniidle.babylon','female',0.0400,0.0400,0.0400,1,363,'stefanifull.png','stefaniface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);
			");
			$wtwdb->query("
	...
	public function checkDBVersionData($zuserid) {
		...
		try {
			...
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('3b9bt5c70igtmqux','Anonymous','Anonymous Male','/content/system/avatars/male/','maleidle.babylon','male',0.0800,0.0800,0.0800,1, 213,'malefull.png','maleface.png',2,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=213, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='3b9bt5c70igtmqux';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=213, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='3b9bt5c70igtmqux';");
			
			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='641svy8bwjx2kme7';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('641svy8bwjx2kme7','Default','Remy','/content/system/avatars/remy/','remyidle.babylon','male',0.0400,0.0400,0.0400,1,196,'remyfull.png','remyface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=196, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='641svy8bwjx2kme7';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=196, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='641svy8bwjx2kme7';");
			
			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='9e94useo7x2ief0s';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('9e94useo7x2ief0s','Default','Liam','/content/system/avatars/liam/','liamidle.babylon','male',0.0400,0.0400,0.0400,1,200,'liamfull.png','liamface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=200, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='9e94useo7x2ief0s';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=200, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='9e94useo7x2ief0s';");
			
			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='aajvq38y06vulgh0';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('aajvq38y06vulgh0','Default','Pearl','/content/system/avatars/pearl/','pearlidle.babylon','female',0.0700,0.0700,0.0700,1,325,'pearlfull.png','pearlface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=325, scalingx=.09, scalingy=.09, scalingz=.09, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='aajvq38y06vulgh0';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=325, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='aajvq38y06vulgh0';");
			$wtwdb->query("update ".wtw_tableprefix."useravatars set scalingx=.09, scalingy=.09, scalingz=.09, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='aajvq38y06vulgh0' and scalingx=.07;");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='dihtmpm1ae3b9d3a';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('dihtmpm1ae3b9d3a','Default','Malcolm','/content/system/avatars/malcolm/','malcolmidle.babylon','male',0.0400,0.0400,0.0400,1,195,'malcolmfull.png','malcolmface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=195, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='dihtmpm1ae3b9d3a';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=195, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='dihtmpm1ae3b9d3a';");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='h1ro3h59xs5eknl0';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('h1ro3h59xs5eknl0','Default','Shae','/content/system/avatars/shae/','shaeidle.babylon','female',0.0400,0.0400,0.0400,1,303,'shaefull.png','shaeface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=303, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='h1ro3h59xs5eknl0';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=303, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='h1ro3h59xs5eknl0';");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='odtx7arzof5eigp4';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('odtx7arzof5eigp4','Default','Regina','/content/system/avatars/regina/','reginaidle.babylon','female',0.0400,0.0400,0.0400,1,241,'reginafull.png','reginaface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=241, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='odtx7arzof5eigp4';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=241, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='odtx7arzof5eigp4';");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='p7y3p6ti6d85yf7q';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('p7y3p6ti6d85yf7q','Anonymous','Anonymous Female','/content/system/avatars/female/','femaleidle.babylon','female',0.0800,0.0800,0.0800,1,100,'femalefull.png','femaleface.png',1,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=100, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='p7y3p6ti6d85yf7q';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=100, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='p7y3p6ti6d85yf7q';");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='r8tgsns20ruwx0bg';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('r8tgsns20ruwx0bg','Default','Jasper','/content/system/avatars/jasper/','jasperidle.babylon','male',0.0700,0.0700,0.0700,1,71,'jasperfull.png','jasperface.png',4,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=71, scalingx=.09, scalingy=.09, scalingz=.09, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='r8tgsns20ruwx0bg';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=71, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='r8tgsns20ruwx0bg';");
			$wtwdb->query("update ".wtw_tableprefix."useravatars set scalingx=.09, scalingy=.09, scalingz=.09, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='r8tgsns20ruwx0bg' and scalingx=.07;");

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avatars where avatarid='v1ij2rkmdypo97c2';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avatars (avatarid, avatargroup, displayname, avatarfolder, avatarfile, gender, scalingx, scalingy, scalingz, startframe, endframe, imagefull, imageface, sortorder, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('v1ij2rkmdypo97c2','Default','Stefani','/content/system/avatars/stefani/','stefaniidle.babylon','female',0.0400,0.0400,0.0400,1,363,'stefanifull.png','stefaniface.png',3,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',0);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avatars set startframe=1, endframe=363, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='v1ij2rkmdypo97c2';");}
			$wtwdb->query("update ".wtw_tableprefix."useravatars set startframe=1, endframe=363, updatedate='".$timestamp."', updateuserid='".$zuserid."' where avatarid='v1ij2rkmdypo97c2';");
			...
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avataranimations (avataranimationid, avatarid, userid, loadpriority, animationevent, animationfriendlyname, setdefault, animationicon, objectfolder, objectfile, startframe, endframe, animationloop, speedratio, soundid, soundpath, soundmaxdistance, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('gfso15ljwulgi6c9','r8tgsns20ruwx0bg','',100,'onwait','Young Male','0','','/content/system/avatars/jasper/','jasperidle.babylon',1,71,1,1.00,'','',50.00,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',2);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avataranimations set endframe=71, avatarid='r8tgsns20ruwx0bg', updatedate='".$timestamp."', updateuserid='".$zuserid."' where avataranimationid='gfso15ljwulgi6c9';"); }

			$zresults = $wtwdb->query("select * from ".wtw_tableprefix."avataranimations where avataranimationid='n3i9s7ophcae5h1r';");
			if (count($zresults) == 0) { $wtwdb->query("INSERT INTO ".wtw_tableprefix."avataranimations (avataranimationid, avatarid, userid, loadpriority, animationevent, animationfriendlyname, setdefault, animationicon, objectfolder, objectfile, startframe, endframe, animationloop, speedratio, soundid, soundpath, soundmaxdistance, createdate, createuserid, updatedate, updateuserid, deleteddate, deleteduserid, deleted) VALUES ('n3i9s7ophcae5h1r','v1ij2rkmdypo97c2','',100,'onwait','Casual Female','0','','/content/system/avatars/stefani/','stefaniidle.babylon',1,363,1,1.00,'','',50.00,'".$timestamp."','".$zuserid."','".$timestamp."','".$zuserid."',NULL,'',2);");}
			else { $wtwdb->query("update ".wtw_tableprefix."avataranimations set endframe=363, avatarid='v1ij2rkmdypo97c2', updatedate='".$timestamp."', updateuserid='".$zuserid."' where avataranimationid='n3i9s7ophcae5h1r';"); }
