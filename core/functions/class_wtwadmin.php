...
class wtwadmin {
	...
	public function loadFullPageFormAdmin() {
		...
		try {
			...
			$pagedata .= "				<div class=\"wtw-dashboardbox\">\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardlabel\">SMTP Email Server</div>\r\n";
			...
			$pagedata .= "					<div class=\"wtw-clear\"></div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardlabel\">Encryption</div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardvalue\">";
			$pagedata .= "						<input type=\"radio\" id=\"wtw_tsmtpencryptionnone\" name=\"wtw_tsmtpencryption\" value=\"\" />None &nbsp;&nbsp;&nbsp;";
			$pagedata .= "						<input type=\"radio\" id=\"wtw_tsmtpencryptionssl\" name=\"wtw_tsmtpencryption\" value=\"ssl\" />SSL &nbsp;&nbsp;&nbsp;";
			$pagedata .= "						<input type=\"radio\" id=\"wtw_tsmtpencryptiontls\" name=\"wtw_tsmtpencryption\" value=\"tls\" />TLS</div>\r\n";
			$pagedata .= "					<div class=\"wtw-clear\"></div>\r\n";
			...
			$pagedata .= "					<div class=\"wtw-clear\"></div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardlabel\">From Email</div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardvalue\"><input type=\"text\" id=\"wtw_tfromemail\" maxlength=\"255\" /></div>\r\n";
			$pagedata .= "					<div class=\"wtw-clear\"></div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardlabel\">From Name</div>\r\n";
			$pagedata .= "					<div class=\"wtw-dashboardvalue\"><input type=\"text\" id=\"wtw_tfromemailname\" maxlength=\"255\" /></div>\r\n";
			$pagedata .= "					<div class=\"wtw-clear\"></div>\r\n";
