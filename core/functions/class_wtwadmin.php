...
class wtwadmin {
	...
	public function loadFullPageFormAdmin() {
		...
		try {
			...
			$zpagedata .= "					<div class=\"wtw-dashboardvalue\"><select id=\"wtw_defaultlanguage\" onchange=\"WTW.saveServerSettings(true);\"></select></div>\r\n";
			...
			$zpagedata .= "								<select id=\"wtw_taliaspathtype\" onchange=\"WTW.setAliasForm();\" >\r\n";
			...
			$zpagedata .= "								<tr>\r\n";
			$zpagedata .= "									<td>&nbsp;</td>\r\n";
			$zpagedata .= "									<td id='wtw_aliasselect1'><select id=\"wtw_aliasdomaincommunityid\" onchange=\"WTW.updateAliasSnapshot(this);\"></select></td>\r\n";
			$zpagedata .= "									<td id='wtw_aliasselect2'>&nbsp;<select id=\"wtw_aliascommunityid\" onchange=\"WTW.updateAliasSnapshot(this);\"></select></td>\r\n";
			$zpagedata .= "									<td id='wtw_aliasselect3'>&nbsp;<select id=\"wtw_aliasbuildingid\" onchange=\"WTW.updateAliasSnapshot();\"></select></td>\r\n";
			$zpagedata .= "									<td id='wtw_aliasselect4'>&nbsp;<select id=\"wtw_aliasthingid\" onchange=\"WTW.updateAliasSnapshot();\"></select></td>\r\n";
			$zpagedata .= "								</tr>\r\n";
			$zpagedata .= "							</table>\r\n";
			...
			$zpagedata .= "								<div class=\"wtw-dashboardvalue\"><input type=\"text\" id=\"wtw_aliassitedescription\" maxlength=\"255\" style=\"width:360px;\" onclick=\"WTW.checkKey(this, 'safetext', 0, 0);WTW.blockPassThrough();\" onkeyup=\"WTW.checkKey(this, 'safetext', 0, 0);\" onblur=\"WTW.checkKey(this, 'safetext', 0, 1);\" /></div>\r\n";
			$zpagedata .= "								<div class=\"wtw-clear\"></div>\r\n";
