...
class wtwmenus {
	...
	public function getSettingsMenu() {
		...
		try {
			...
			$zmenu .= "				<input id='wtw_tcameradistance' type='range' min='-100' max='100' value='-25' step='1' style='direction: ltr;width:240px;cursor:pointer;' oninput='WTW.changeCameraDistance();' onchange='WTW.changeCameraDistance();this.blur();'/>\r\n";
			$zmenu .= "			</li>\r\n";
			...
			foreach ($this->settingsforms as $zform) {
				...
				if ($wtwdb->hasPermission($zaccessrequired) || empty($zaccessrequired) || !isset($zaccessrequired)) {
					...
					if (!empty($zformdata) && isset($zformdata)) {
						...
						$zmenuforms .= "	<img id='".$zformid."min' class='wtw-closeright wtw-hide' onclick=\"WTW.resizeMenu('".$zformid."', 'min');\" src='/content/system/images/menuminimize.png' alt='".$wtwdb->__("Minimize")." ".$wtwdb->__($ztitle)."' title='".$wtwdb->__("Minimize")." ".$wtwdb->__($ztitle)."' onmouseover=\"this.src='/content/system/images/menuminimizehover.png';\" onmouseout=\"this.src='/content/system/images/menuminimize.png';\" />\r\n";
						$zmenuforms .= "	<img id='".$zformid."max' class='wtw-closeright wtw-hide' onclick=\"WTW.resizeMenu('".$zformid."', 'max');\" src='/content/system/images/menumaximize.png' alt='".$wtwdb->__("Maximize")." ".$wtwdb->__($ztitle)."' title='".$wtwdb->__("Maximize")." ".$wtwdb->__($ztitle)."' onmouseover=\"this.src='/content/system/images/menumaximizehover.png';\" onmouseout=\"this.src='/content/system/images/menumaximize.png';\" />\r\n";
	...
	public function getProfileMenu() {
		...
		try {
			...
			$zmenu .= "				<li class='wtw-submenuli'><div id='wtw_menudisplayname' class='wtw-indentbold' onclick='WTW.editProfile();'></div>\r\n";
			$zmenu .= "					<input type='text' id='wtw_teditdisplayname' class='wtw-hide' /></li>\r\n";
			$zmenu .= "				<li class='wtw-submenuli'>".$this->__("User Information")."</li>\r\n";
			$zmenu .= "				<li class='wtw-submenuli'><div id='wtw_menuemail' class='wtw-indentbold' onclick='WTW.editProfile();'>".$this->__("Email")."</div>\r\n";
			$zmenu .= "					<input type='text' id='wtw_teditemail' autocomplete='email' class='wtw-hide' /></li>\r\n";
			$zmenu .= "				<li class='wtw-menuliholder'><div id='wtw_profileerrortext' style='color:red;margin-left:10px;'></div></li>\r\n";
			$zmenu .= "				<li id='wtw_menusaveprofile' class='wtw-menuli wtw-hide' onclick='WTW.saveProfile();'><img src='/content/system/images/menulogin.png' alt='Save Profile' title='Save Profile' class='wtw-menulefticon' /><div style='color:yellow;'>".$this->__("Save Profile")."</div></li>\r\n";
			...
			$zmenu .= "				<li class='wtw-menuli' onclick=\"WTW.closeMenus();WTW.openLocalLogin('Select Avatar',.4,.9);\"><img src='/content/system/images/menueditavatar.png' alt='Select My Avatar' title='Select My Avatar' class='wtw-menulefticon' />".$this->__("Select My Avatar")."</li>\r\n";
			...
			$zmenu .= "				<li class='wtw-menuli' onclick='WTW.openLoginMenu();WTW.closeMenus();'><img src='/content/system/images/menulogin.png' alt='Login Menu' title='Login Menu' class='wtw-menulefticon' /><div style='color:yellow;'>".$this->__("Login Menu")."</div></li>\r\n";
			...
			$zmenu .= "				<ul class='wtw-menuli'>\r\n";
			$zmenu .= "					<li class='wtw-menuli' onclick='WTW.openLoginMenu();WTW.closeMenus();'><img src='/content/system/images/menulogin.png' alt=\"".$this->__("Login Menu")."\" title=\"".$this->__("Login Menu")."\" class='wtw-menulefticon' /><div style='color:yellow;'>".$this->__("Login")."</div></li>\r\n";
			...
			$zmenu .= "					<li class='wtw-menuli' onclick=\"WTW.openLocalLogin('Create Login', .4, .7);WTW.closeMenus();\"><img src='/content/system/images/menuregister.png' alt=\"".$this->__("Create My Account")."\" title=\"".$this->__("Create My Account")."\" class='wtw-menulefticon' /><div style='color:yellow;'>".$this->__("Create My Account")."</div></li>\r\n";
			$zmenu .= "				</ul>\r\n";
			$zmenu .= "			</form>\r\n";
			$zmenu .= "		</div>\r\n";
			$zmenu .= "	</div>\r\n";
	...
	public function getContentRatingMenu() {
		...
		try {
			...
			$zmenu .= "	<div id='wtw_menucontentratingscroll' class='wtw-mainmenuscroll' style='min-height:300px;'>\r\n";
	...
	public function getAvatarMenu() {
		...
		try {
			...
			$zmenu .= "					<div style='font-size:.8em;text-align:center;background-color:#000000;border:1px solid gray;'>".$this->__("For Mouse or Keyboard Controls")."<br />".$this->__("Mouse must be over 3D Scene to move.")."</div>\r\n";
			$zmenu .= "					<div class='wtw-menusubtext'>".$this->__("Select Animation to Edit:")."</div>\r\n";
			$zmenu .= "					<ul style='padding:0px;'>\r\n";
			...
			$zmenu .= "						<select id='wtw_tselectavataranimation-enter' onchange='WTW.saveAvatarEnterAnimation();'>\r\n";
	...
	public function getOptionalAnimations() {
		...
		$zmenu = "";
		try {
			$zmenu .= "<div id='wtw_menuoptionalanimations' class='wtw-slideupanimations' style='display:none;visibility:hidden;'>\r\n";
			...
			$zmenu .= "		<div class='wtw-menuheading' style='text-align:left;'>".$this->__("Press and Hold to Play")."<div id='wtw_avataranimationmode' class='wtw-avataranimationmode'>".$this->__("Mode:")."<div id='wtw_animationmodenormal' class='wtw-animationmodeselected' onclick=\"WTW.avatarAnimationMode('');\">".$this->__("Normal")."</div><div id='wtw_animationmodefight' class='wtw-animationmode wtw-hide' onclick=\"WTW.avatarAnimationMode('fight');\">".$this->__("Fight")."</div></div></div>\r\n";
	...
	public function getControlsMenu() {
		...
		try {
			...
			$zmenu .= "				<a href='https://www.walktheweb.com/shop/walktheweb-3d-glasses/' target='_blank'><img src='/content/system/images/3DGlassesFor5.png' alt='3D Glasses for $5' title='3D Glasses for $5' style='width:95%;height:auto;margin:2%;' /></a /></li>\r\n";
			...
			$zmenu .= "				<div style='font-size:.8em;text-align:center;'>".$this->__("Mouse must be over 3D Scene to move.")."</div>\r\n";
			$zmenu .= "				<img src='/content/system/images/helpmouse.png' alt=\"".$this->__("Mouse Walk Controls")."\" title=\"".$this->__("Mouse Walk Controls")."\" style='width:95%;height:auto;margin:2%;' /><br />\r\n";
			$zmenu .= "				<img src='/content/system/images/helpmousemove.png' alt=\"".$this->__("Mouse Pan Controls")."\" title=\"".$this->__("Mouse Pan Controls")."\" style='width:100%;height:auto;' /></li>\r\n";
			...
			$zmenu .= "				<div style='font-size:.8em;text-align:center;'>".$this->__("Mouse must be over 3D Scene to move.")."</div>\r\n";
			$zmenu .= "				<img src='/content/system/images/helpkeyboard.png' alt=\"".$this->__("Keyboard Controls")."\" title=\"".$this->__("Keyboard Controls")."\" style='width:95%;height:auto;margin:2%;' /></li>\r\n";
			...
			$zmenu .= "			<li id='wtw_helptouchdiv' class='wtw-submenublockli wtw-hide'><img src='/content/system/images/helptouch3.png' alt=\"".$this->__("Touch Controls")."\" title=\"".$this->__("Touch Controls")."\" style='width:95%;height:auto;margin:2%;' /></li>\r\n";
			...
			$zmenu .= "				<img src='/content/system/images/helpcameras.png' alt=\"".$this->__("Camera Position and Views")."\" title=\"".$this->__("Camera Position and Views")."\" style='width:95%;height:auto;margin:2%;' /></li>\r\n";
			$zmenu .= "			<li class='wtw-menuli' onclick='WTW.openLoginMenu();'>\r\n";
			$zmenu .= "				<img src='/content/system/images/menulogin.png' alt='Login' title='Login' class='wtw-menulefticon' /><div style='color:yellow;'>".$this->__("Login")."</div></li>\r\n";
			$zmenu .= "		</ul>\r\n";
	...
	public function getMovementMenu() {
		...
		try {
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input id='wtw_twalkanimationspeed' type='range' min='.1' max='2.9' value='1.5' step='.01' style='direction: ltr;width:240px;cursor:pointer;' onchange='WTW.changeWalkAnimationSpeed();this.blur();'/></li>\r\n";
			$zmenu .= "		</ul>\r\n";
			$zmenu .= "		<ul class='wtw-menuli'>\r\n";
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input id='wtw_twalkspeed' type='range' min='.1' max='2.9' value='1.5' step='.01' style='direction: ltr;width:240px;cursor:pointer;' onchange='WTW.changeWalkSpeed();this.blur();'/></li>\r\n";
			$zmenu .= "		</ul>\r\n";
			$zmenu .= "		<ul class='wtw-menuli'>\r\n";
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input id='wtw_tturnanimationspeed' type='range' min='.1' max='1.9' value='1' step='.01' style='direction: ltr;width:240px;cursor:pointer;' onchange='WTW.changeTurnAnimationSpeed();this.blur();'/></li>\r\n";
			$zmenu .= "		</ul>\r\n";
			$zmenu .= "		<ul class='wtw-menuli'>\r\n";
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input id='wtw_tturnspeed' type='range' min='.1' max='1.9' value='1' step='.01' style='direction: ltr;width:240px;cursor:pointer;' onchange='WTW.changeTurnSpeed();this.blur();'/></li>\r\n";
			$zmenu .= "		</ul>\r\n";
			$zmenu .= "	</div>\r\n";
			$zmenu .= "</div>\r\n";
		} catch (Exception $e) {
	...
	public function getGraphicsMenu() {
		...
		try {
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input type='button' value='Lower' style='display:inline-block;cursor:pointer;' onclick='WTW.changeGraphic(-1);' />\r\n";
			$zmenu .= "				<input id='wtw_tgraphicsetting' type='range' min='0' max='2' defaultValue='0' step='1' style='cursor:pointer;' onchange='WTW.changeGraphic(this.value);'/>\r\n";
			$zmenu .= "				<input type='button' value='Higher' style='display:inline-block;cursor:pointer;' onclick='WTW.changeGraphic(1);' /></li>\r\n";
			$zmenu .= "			<li id='wtw_graphichelptitle' class='wtw-submenuli wtw-menunoteset'>".$this->__("Graphics (Optimum Balance)")."</li>\r\n";
			$zmenu .= "			<li id='wtw_graphichelpadmin' class='wtw-submenuli wtw-menunoteset wtw-hide' style='font-size:.8em;color:red;'>".$this->__("Admin Mode Overrides to Optimum")."</li>\r\n";
			$zmenu .= "		</ul>\r\n";
			$zmenu .= "	</div>\r\n";
			$zmenu .= "</div>\r\n";
		} catch (Exception $e) {
	...
	public function getShadowsMenu() {
		...
		try {
			...
			$zmenu .= "			<li class='wtw-submenuli'>\r\n";
			$zmenu .= "				<input type='button' value='Lower' style='display:inline-block;cursor:pointer;' onclick='WTW.changeShadow(-1);' />\r\n";
			$zmenu .= "				<input id='wtw_tshadowsetting' type='range' min='0' max='3' defaultValue='0' step='1' style='cursor:pointer;' onchange='WTW.changeShadow(this.value);'/>\r\n";
			$zmenu .= "				<input type='button' value='Higher' style='display:inline-block;cursor:pointer;' onclick='WTW.changeShadow(1);' /></li>\r\n";
	...
	public function getFeedbackMenu() {
		...
		try {
			...
			$zmenu .= "					<select id='wtw_feedbacktype'>\r\n";
			...
			$zmenu .= "					<select id='wtw_feedbackcategory'>\r\n";
			...
			$zmenu .= "					<img id='wtw_feedbacksnapshot' class='wtw-snapshot wtw-hide' style='width:90%;height:auto;' /><br />\r\n";
