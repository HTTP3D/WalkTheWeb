...
// All code is Copyright 2013-2016 Aaron Scott Dishno Ed.D. (Author of the code) and HTTP3D Inc. 
...
// Licensing, developer opportunities, and hosted solution options available, please contact adishno@http3d.net for details
function WTWJS() {
	this.adminView = 0;
}
var WTW = new WTWJS();
