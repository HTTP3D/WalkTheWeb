...
/*				screen capture for Babylon Canvas */
...
WTWJS.prototype.snapshot3D = function(zfilepath, zfilename) {
	...
	try {
		...
		WTW.log("core-scripts-prime-wtw_utilities.js-snapshot3D=" + ex.message);
	} 
}
...
WTWJS.prototype.updateSnapshot3D = function(zcommunityid, zbuildingid, zthingid, zsnapshotid, zsnapshotpath, zfiledata) {
	...
	try {
		...
		WTW.log("core-scripts-prime-wtw_utilities.js-updateSnapshot3D=" + ex.message);
	} 
}
