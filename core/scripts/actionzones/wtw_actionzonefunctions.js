							...
							function(zresponse) {
								...
								if (zteleportwebid != zoldwebid || zteleportwebtype != zoldwebtype) {
									...
									WTW.init = {
										...
										'sunPositionX':Number(zresponse.communityinfo.sunpositionx),
										'sunPositionY':Number(zresponse.communityinfo.sunpositiony),
										'sunPositionZ':Number(zresponse.communityinfo.sunpositionz),
										...
										'backLightPositionX':Number(zresponse.communityinfo.backlightpositionx),
										'backLightPositionY':Number(zresponse.communityinfo.backlightpositiony),
										'backLightPositionZ':Number(zresponse.communityinfo.backlightpositionz),
