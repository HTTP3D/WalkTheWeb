			...
			function(zresponse) {
				...
				for (var i=0;i<zresponse.length;i++) {
					...
					if (zitem == '3dobject') {
						...
						zuploadedobjectsdiv += "<div id='wtw_obj_" + i + "_" + zresponse[i].objectfile.toLowerCase() + "-" + zresponse[i].groupid + "' class='wtw-objectcontainer'><div class='wtw-objectfile' onclick=\"WTW.openObjectPageForm('" + zresponse[i].uploadobjectid + "','" + zresponse[i].objectfile + "');\">" + zresponse[i].objectfile + "</div><div class='wtw-objectfolder'><canvas id='wtw_modelCanvas" + i + "' style='border:1px solid black;display:none;visibility:hidden;'></canvas>" + zresponse[i].objectfolder.replace("/objects/","/objects<br />/") + "<br /><br />" + zanimationdiv + "<b>(" + zfilecount + ")</b> File(s) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" + zfoldersize + " MB</b> Total<br /><br /><span style='color:gray;'>Uploaded on </span>" + zcreatedate + "<br /><br />" + zwebcount + "<div class='wtw-leftbutton' onclick=\"WTW.openIFrame('/core/pages/models.php?objectfile=" + zresponse[i].objectfolder + zresponse[i].objectfile + "',.8,.8,'Preview " + zresponse[i].objectfile + "');\">Preview</div><div id='wtw_bduplicate_" + zresponse[i].uploadobjectid + "' class='wtw-leftbutton' onclick=\"WTW.selectObjectDuplicate('" + zresponse[i].uploadobjectid + "','" + zresponse[i].objectfile.toLowerCase() + "', 'wtw_obj_" + i + "_" + zresponse[i].objectfile.toLowerCase() + "-" + zresponse[i].groupid + "');\">Duplicate</div><div id='wtw_bgroup_" + zresponse[i].uploadobjectid + "' class='wtw-leftbutton' onclick=\"WTW.selectObjectGroup('" + zresponse[i].uploadobjectid + "','" + zresponse[i].groupid + "', 'wtw_obj_" + i + "_" + zresponse[i].objectfile.toLowerCase() + "-" + zresponse[i].groupid + "');\" onmouseover=\"WTW.showObjectGroup('" + zresponse[i].uploadobjectid + "','" + zresponse[i].groupid + "',true);\" onmouseout=\"WTW.showObjectGroup('" + zresponse[i].uploadobjectid + "','" + zresponse[i].groupid + "',false);\">Group</div><div class='wtw-leftbutton' onclick=\"WTW.openObjectPageForm('" + zresponse[i].uploadobjectid + "','" + zresponse[i].objectfile + "');\">" + zlinktext + "</div>";
						if (communityid != '' || buildingid != '' || thingid != '') {
							zuploadedobjectsdiv += "<div class='wtw-leftbutton' onclick=\"WTW.openAddNew3DModel('" + zresponse[i].uploadobjectid + "','" + zresponse[i].objectfolder + "','" + zresponse[i].objectfile + "');\">Add to Scene</div>";
						}
						zuploadedobjectsdiv += "<div class='wtw-clear'></div></div></div>";
					}
