...
<body>
	<form id="wtw_form1" action="molds.php" method="post">
		...
		<input type="hidden" id="wtw_tmoldproductid" name="wtw_tmoldproductid" maxlength="64" />
		<input type="hidden" id="wtw_tmoldslug" name="wtw_tmoldslug" maxlength="255" />
		<input type="hidden" id="wtw_tmoldcategoryid" name="wtw_tmoldcategoryid" maxlength="64" />
		<input type="hidden" id="wtw_tmoldallowsearch" name="wtw_tmoldallowsearch" maxlength="1" />
