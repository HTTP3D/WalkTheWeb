...
<div id="wtw_adminmenu39b" class="wtw-hide">
	...
	<br /><br />
	<h2>Description</h2>
	<textarea id="wtw_tsharethingdescription" rows="4" onclick="WTW.checkKey(this, 'displayname', 0, 0);WTW.blockPassThrough();" onkeyup="WTW.checkKey(this, 'displayname', 0, 0);" onblur="WTW.checkKey(this, 'displayname', 0, 1);"></textarea>
	<br /><br />
