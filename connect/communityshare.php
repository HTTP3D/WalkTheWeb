...
//	echo $wtwconnect->addConnectHeader('*');
	...
	foreach ($zresults as $zrow) {
		...
		$zresponse = array(
			...
			'buildingpositionx' => $zrow["buildingpositionx"],
			'buildingpositiony' => $zrow["buildingpositiony"],
			'buildingpositionz' => $zrow["buildingpositionz"],
			'buildingscalingx' => $zrow["buildingscalingx"],
			'buildingscalingy' => $zrow["buildingscalingy"],
			'buildingscalingz' => $zrow["buildingscalingz"],
			'buildingrotationx' => $zrow["buildingrotationx"],
			'buildingrotationy' => $zrow["buildingrotationy"],
			'buildingrotationz' => $zrow["buildingrotationz"],
			'createdate' => $zrow["createdate"],
			'createuserid' => $zrow["createuserid"],
			'updatedate' => $zrow["updatedate"],
			'updateuserid' => $zrow["updateuserid"],
