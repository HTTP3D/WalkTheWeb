...
try {
	...
	require_once(WTW_3DINTERNET_PATH . '/functions/class_bans.php');
	global $wtw_3dinternet_bans;
	/* get sent data */
	...
	switch ($zfunction) {
		case "saveban":
			$zresponse = $wtw_3dinternet_bans->saveBan($zblockedinstanceid, $zinstanceid, $zuserid, $zbaninstanceid, $zbanuserid, $zbanuserip, $zbanuseravatarid, $zbanglobalavatarid, $zblockchat, $zbanuser);
			break;
	}
	...
	$wtwhandlers->serror("core-handlers-wtw-3dinternet-bans.php=".$e->getMessage());
}
?>