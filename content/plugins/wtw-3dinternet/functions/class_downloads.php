						...
						if ($wtwhandlers->hasValue($zfoundcommunityid)) {
							...
							$wtwhandlers->query("
								...
								set versionid='".$zrequest->versionid."',
									...
									sunpositionx=".$wtwhandlers->checkNumber($zrequest->sunpositionx,0).",
									sunpositiony=".$wtwhandlers->checkNumber($zrequest->sunpositiony,1000).",
									sunpositionz=".$wtwhandlers->checkNumber($zrequest->sunpositionz,0).",
									...
									backlightpositionx=".$wtwhandlers->checkNumber($zrequest->backlightpositionx,0).",
									backlightpositiony=".$wtwhandlers->checkNumber($zrequest->backlightpositiony,1000).",
									backlightpositionz=".$wtwhandlers->checkNumber($zrequest->backlightpositionz,0).",
							...
							$wtwhandlers->query("
								...
								values
								   ('".$znewcommunityid."',
									...
									".$wtwhandlers->checkNumber($zrequest->sunpositionx,0).",
									".$wtwhandlers->checkNumber($zrequest->sunpositiony,1000).",
									".$wtwhandlers->checkNumber($zrequest->sunpositionz,0).",
									...
									".$wtwhandlers->checkNumber($zrequest->backlightpositionx,0).",
									".$wtwhandlers->checkNumber($zrequest->backlightpositiony,1000).",
									".$wtwhandlers->checkNumber($zrequest->backlightpositionz,0).",
					...
					if (!empty($zsql)) {
						...
						if ($wtwhandlers->hasValue($zfoundmoldid)) {
							...
							$zsql .= "
								...
								physicsenabled=".$zmold->physicsenabled.",
								physicscenterx=".$zmold->physicscenterx.",
								physicscentery=".$zmold->physicscentery.",
								physicscenterz=".$zmold->physicscenterz.",
								physicsextentsx=".$zmold->physicsextentsx.",
								physicsextentsy=".$zmold->physicsextentsy.",
								physicsextentsz=".$zmold->physicsextentsz.",
								physicsfriction=".$zmold->physicsfriction.",
								physicsistriggershape=".$zmold->physicsistriggershape.",
								physicsmass=".$zmold->physicsmass.",
								physicspointax=".$zmold->physicspointax.",
								physicspointay=".$zmold->physicspointay.",
								physicspointaz=".$zmold->physicspointaz.",
								physicspointbx=".$zmold->physicspointbx.",
								physicspointby=".$zmold->physicspointby.",
								physicspointbz=".$zmold->physicspointbz.",
								physicsradius=".$zmold->physicsradius.",
								physicsrestitution=".$zmold->physicsrestitution.",
								physicsrotationw=".$zmold->physicsrotationw.",
								physicsrotationx=".$zmold->physicsrotationx.",
								physicsrotationy=".$zmold->physicsrotationy.",
								physicsrotationz=".$zmold->physicsrotationz.",
								physicsstartasleep=".$zmold->physicsstartasleep.",
								alttag='".$zmold->alttag."',
							...
							$zsqlvalues .= "
								...
								'".$zmold->csgmoldid."',
								'".$zmold->csgaction."',
								".$zmold->physicsenabled.",
								".$zmold->physicscenterx.",
								".$zmold->physicscentery.",
								".$zmold->physicscenterz.",
								".$zmold->physicsextentsx.",
								".$zmold->physicsextentsy.",
								".$zmold->physicsextentsz.",
								".$zmold->physicsfriction.",
								".$zmold->physicsistriggershape.",
								".$zmold->physicsmass.",
								".$zmold->physicspointax.",
								".$zmold->physicspointay.",
								".$zmold->physicspointaz.",
								".$zmold->physicspointbx.",
								".$zmold->physicspointby.",
								".$zmold->physicspointbz.",
								".$zmold->physicsradius.",
								".$zmold->physicsrestitution.",
								".$zmold->physicsrotationw.",
								".$zmold->physicsrotationx.",
								".$zmold->physicsrotationy.",
								".$zmold->physicsrotationz.",
								".$zmold->physicsstartasleep.",
								'".$zmold->alttag."',
								'".$zmold->jsfunction."',
								'".$zmold->jsparameters."',
								'".$zmold->createdate."',
