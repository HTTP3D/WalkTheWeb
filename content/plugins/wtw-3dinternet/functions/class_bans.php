...
class wtw_3dinternet_bans {
	...
	public function __construct() {
		...
		try {
			...
			$wtwplugins->serror("plugins:wtw-3dinternet:functions-class_bans.php-construct=".$e->getMessage());
		}
	}	
	...
	public function defineConstants() {
		...
		try {
			...
			$wtwplugins->serror("plugins:wtw-3dinternet:functions-class_bans.php-defineConstants=".$e->getMessage());
		}
	}
	...
	public function initClass() {
		...
		try {
			...
			$wtwplugins->serror("plugins:wtw-3dinternet:functions-class_bans.php-initClass=".$e->getMessage());
		}
	}
	...
	public function saveBan($zblockedinstanceid, $zinstanceid, $zuserid, $zbaninstanceid, $zbanuserid, $zbanuserip, $zbanuseravatarid, $zbanglobalavatarid, $zblockchat, $zbanuser) {
		...
		try {
			...
			$wtwplugins->serror("plugins:wtw-3dinternet:functions-class_bans.php-saveBan=".$e->getMessage());
			$zresponse = array(
	...
	function wtw_3dinternet_bans() {
		return wtw_3dinternet_bans::instance();
	}

	/* Global for backwards compatibility. */
	$GLOBALS['wtw_3dinternet_bans'] = wtw_3dinternet_bans();
