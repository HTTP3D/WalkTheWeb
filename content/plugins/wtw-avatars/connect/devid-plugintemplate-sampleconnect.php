...
try {
	...
	$wtwconnect->trackPageView($wtwconnect->domainurl."/connect/wtw-avatars-sample.php");
	...
	if (!empty($zprotectedname) && isset($zprotectedname)) {
		$zresults = $wtwconnect->query("
			select *
			from ".WTW_AVATARS_PREFIX."tablename  
	...
	$wtwconnect->serror("plugins:wtw-avatars:connect-wtw-avatars-sample.php=".$e->getMessage());
}
?>
